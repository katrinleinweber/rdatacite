...
Note that searching a specific field (as above) requires your input to be named.
Another example for this: all datasets _relating_ to a given article.

```{r}
dc_search(q = "relatedIdentifier:\"10.5438/0012\"")
```
